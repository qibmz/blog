---
title: UniApp H5 多文件上传：绕过 uni.uploadFile 单文件限制（fetch + FormData）
description: uni.uploadFile / uni.upload 一次只能传一个文件时，在 H5 用 fetch + FormData 一次提交多个文件的实现方式与注意点。
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/file-upload-issue-solution.webp
authors:
  - name: qibmz
    avatar:
