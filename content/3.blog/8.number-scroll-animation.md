---
title: Vue 3 数字滚动动画：Composition API + requestAnimationFrame 实现
description: 用 Vue 3 Composition API 与 requestAnimationFrame 实现数字滚动（CountUp）组件，覆盖取消动画、内存泄漏与性能优化。
date: 2026-02-05
badge:
  label: Vue3
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/number-scroll-animation.webp
authors:
  - name: qibmz
    avatar:
...
完整交互式演示请访问 [数字滚动动画Demos](/playground/number-scroll)。
...
[前往Demos →](/playground/number-scroll)
