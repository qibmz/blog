---
title: 'UniApp z-paging easycom 与 vite-plugin-uni-components 冲突：H5 组件变成原始标签'
description: 'UniApp 配置 z-paging easycom 后与 @uni-helper/vite-plugin-uni-components 冲突，CICD 打包 H5 构建成功但页面组件渲染为原始标签。本文给出冲突原因与修复方式。'
date: '2026-07-27'
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/uniapp-z-paging-easycom-conflict.webp
authors:
  - name: qibmz
    avatar:
