---
title: Apifox + openapi-ts-request：自动生成类型安全的 API 请求代码
description: 根据 Apifox OpenAPI 文档，用 openapi-ts-request 自动生成 TypeScript 请求函数与类型，减少手写 API 封装。
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/apifox-api-generation.webp
authors:
  - name: qibmz
    avatar:
