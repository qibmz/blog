---
title: 'UniApp RootPortal：修复 uview-plus Popup/Modal 遮罩层层级异常'
description: 'UniApp 深层组件里的 Popup、Modal 遮罩被父级 overflow/z-index 裁切或盖住时，用 RootPortal 传送到页面根节点解决；适用于 uview-plus 等弹层组件。'
date: '2026-04-22'
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/uniapp-root-portal.webp
authors:
  - name: qibmz
    avatar:
