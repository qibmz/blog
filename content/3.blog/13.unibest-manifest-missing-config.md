---
title: 'Unibest 默认配置下 build:app 产物 manifest.json 缺失 tabBar 等配置导致 wgt 热更新白屏'
description: '记录使用 Unibest 框架时，默认 install 后执行 build:app，生成的 manifest.json 缺失 pages.config.ts 中 tabBar 等配置，热更新 wgt 包安装后 App 白屏的原因与解决方案。'
date: '2026-07-29'
image:
