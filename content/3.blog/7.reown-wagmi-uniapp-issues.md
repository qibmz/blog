---
title: 'UniApp + Vite 集成 Reown / Wagmi：打包失败、兼容性与 RPC 问题'
description: 'UniApp Vite 项目接入 Reown（AppKit）与 Wagmi 时的打包报错、浏览器 API 兼容、RPC 访问失败等常见问题与对应解决办法。'
date: '2026-01-22' 
image:
  src: https://pub-6d1497ab7602406d9ac97574064124fe.r2.dev/blogs/reown-wagmi-uniapp-issues.webp
authors:
  - name: qibmz
    avatar:
